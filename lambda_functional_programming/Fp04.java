...
public class Fp04 {
	...
	public static void main(String[] args) {
		...
		System.out.println(sumOfIntegersInTheGivenRange(11, 100));
	...
	public static int getSumFromSevenToHundred01() {
		//IntStream .range(7, 101) does the same with foor loop in structured programming
	...
	public static Object calculateFactorial(int x) {
			return x>0 ? IntStream.rangeClosed(1, x).reduce(1, Math::multiplyExact) : 	"factoriel should not be negative number";	
	}
	
	//4)Create a method to calculate the sum of even integers between given two integers
	public static int sumOfIntegersInTheGivenRange(int s, int e) {
		int x = 0;
		if(s>e) {
			x = s;
			s = e;
